...
test('Is ArrayToFen function defined', ()=>{
    expect(arrayToFen(fieldsTest1)).toBeDefined();
});

test('arrayToFen(fieldsTest1) returns fen notation1 ', () => {
    expect(arrayToFen(fieldsTest1.reverse())).toEqual('rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR');
});

test('arrayToFen(fieldsTest2) returns fen notation2', () => {
    expect(arrayToFen(fieldsTest2.reverse())).toEqual('r1bqkbn1/pp1ppppr/8/8/8/2p5/RPPPPP1P/RNBQKBN1');
} )
